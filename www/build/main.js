            ...
            if (_this.properties.isRecording) {
                ...
                var errorLoop_1 = setInterval(function () {
                    ...
                    if (errorCount_1 > 10) {
                        ...
                        _this.setupRecognition();
                        setTimeout(function () { _this.recognitionObject.start(); }, 200);
